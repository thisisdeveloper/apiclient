        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-full">
            <div className="lg:col-span-2 flex flex-col gap-8 min-h-0">
              <div className="bg-white shadow rounded-lg p-6 flex-none">
                <RequestForm
              ...
              {(activeTab?.response || activeTab?.error) && (
                <div className="bg-white shadow rounded-lg p-6 flex-1 min-h-0">
                  <ResponseView
            ...
            <div className="bg-white shadow rounded-lg p-6 h-full min-h-0">
              <History
                items={history}
